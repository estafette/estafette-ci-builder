...
func TestGenerateEntrypointScript(t *testing.T) {
	...
	t.Run("ReturnsHostPathEndingWithEntrypointFileName", func(t *testing.T) {
		...
		assert.Nil(t, err)
		assert.True(t, strings.HasSuffix(hostPath, "/entrypoint.sh"))
	})

	t.Run("ReturnsMountPathWithEntrypointFilename", func(t *testing.T) {
