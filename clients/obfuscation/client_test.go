...
func TestObfuscate(t *testing.T) {
	...
	t.Run("ObfuscatesSecretInManifest", func(t *testing.T) {
		...
		obfuscationClient, _ := getObfuscationClient()
		...
		obfuscationClient.CollectSecrets(manifest, credentialsBytes, pipeline)

		// act
		output := obfuscationClient.Obfuscate("this is my secret")
	...
	t.Run("ObfuscatesBase64EncodedSecretInManifest", func(t *testing.T) {
		...
		obfuscationClient, secretHelper := getObfuscationClient()
		...
		for _, l := range unencryptedValueLines {
			...
			output := obfuscationClient.Obfuscate(input)
	...
	t.Run("ObfuscatesMultilineSecretInManifestWhenEncodedNewlineIsNotOutputedAsNewlineExceptForSingleCharacterLines", func(t *testing.T) {
	...
	t.Run("ObfuscatesMultilineSecretInManifestInLogLineFollowedByNewlineExceptForSingleCharacterLines", func(t *testing.T) {
...
func getObfuscationClient() (Client, crypt.SecretHelper) {
	ctx := context.Background()
	secretHelper := crypt.NewSecretHelper("SazbwMf3NZxVVbBqQHebPcXCqrVn3DDp", false)
	obfuscationClient, _ := NewClient(ctx, secretHelper)

	return obfuscationClient, secretHelper
}
